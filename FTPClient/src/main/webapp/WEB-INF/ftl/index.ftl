...
<html>
    <head>
        ...
        <meta name="description" content="吉林省高速公路收费稽查管理系统--FTP客户端工具" />
        <meta name="keywords" content="吉林省高速公路收费稽查管理系统--FTP客户端工具,Management,FXStudio"/>
        <meta name="Copyright" content="Copyright fxstudio.com.cn All Rights Reserved."/>

        <title>吉林省高速公路收费稽查管理系统--FTP客户端工具</title>
    ...
    <body>
        ...
        <script src="javascript/modules/manualDownload/app.js"></script>
    </body>
</html>
